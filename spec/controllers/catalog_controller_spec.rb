  ...
  describe "index action" do
    ...
    describe "with format :json" do
      ...
      it "gets the documents" do
        ...
        expect(docs.first['attributes'].keys).to match_array(["published_display", "author_display", "lc_callnum_display", "pub_date", "subtitle_display", "format", "material_type_display", "title_display", "id", "subject_topic_facet", "language_facet", "score"])
